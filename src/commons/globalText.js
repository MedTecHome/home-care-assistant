...
export const REGEX_POSITIVE_NUMBER_AND_DECIMAL_AND_FRACTION = /^\d+(((.[1-9]){1}?)|((\/[1-9]){1}?))?$/;
export const REGEX_ALPHANUMERIC_AND_SPACE = /^[-\w\s]+$/;
export const REGEX_PHONE = /^[0-9]{3,25}(((-|\s)[0-9]+)?)+$/;
export const REGEX_ONLY_ALPHA = /^[a-záéíóúA-ZÁÉÍÓÚ\s]+$/;
export const REGEX_ONLY_ALPHANUMERIC = /^[a-záéíóúA-ZÁÉÍÓÚ0-9]+$/;
